...
const stats = [
  { icon: '🗓️', value: '200+', label: 'DAYS WORKED', color: 'bg-sky-50 border-sky-200' },
  { icon: '📑', value: '10', label: 'DOCUMENTS', color: 'bg-rose-50 border-rose-200' },
  { icon: '🎤', value: '4', label: 'PRESENTATIONS', color: 'bg-amber-50 border-amber-200' },
  { icon: '🏁', value: '8', label: 'MILESTONES', color: 'bg-emerald-50 border-emerald-200' },
];
        ...
        <div className="space-y-6">
          {achievements.map((item, i) => (
            <RevealOnScroll key={i} delay={`${i * 150}ms`}>
              <div className="group relative overflow-hidden bg-white rounded-3xl border border-border shadow-card card-hover">
                  ...
                  <div className="flex-1">
                    ...
                    {item.link && (
                      <a 
                        ...
                        className="inline-block mt-3 text-sm font-semibold text-blue-600 hover:text-blue-800 hover:underline transition-colors"
                      >
